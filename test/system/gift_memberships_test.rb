...
class GiftMembershipsTest < ApplicationSystemTestCase
  ...
  test "creating a gift membership" do
    ...
    assert_delivered_email(to: "created@place.biz") do |html, text, attachments|
      assert_includes html, "You have successfully purchased a One Year Gift Membership to The System Test Library"
      assert_includes html, gift_membership.code.format

      assert_includes text, "You have successfully purchased a One Year Gift Membership to the System Test Library"
