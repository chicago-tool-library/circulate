...
class LendingTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    create(:appointment_slot_event, start: Time.utc(2020, 2, 2))
    create(:appointment_slot_event, start: Time.utc(2020, 2, 6))
    create(:appointment_slot_event, start: Time.utc(2020, 2, 9))
    create(:appointment_slot_event, start: Time.utc(2020, 2, 13))

    # Open next week and the week after
    create(:appointment_slot_event, start: 7.days.from_now)
    create(:appointment_slot_event, start: 14.days.from_now)
  end
