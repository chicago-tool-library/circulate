module Admin
  class MembersController < BaseController
    ...
    def member_params
      params.require(:member).permit(:full_name, :preferred_name, :email, :pronoun, :custom_pronoun, :phone_number, :notes, :id_kind, :other_id_kind, :id_number, :address_verified)
    end
  end
end
