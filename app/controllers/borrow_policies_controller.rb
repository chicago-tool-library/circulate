class BorrowPoliciesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @borrow_policy.save
        format.html { redirect_to @borrow_policy, notice: 'Borrow policy was successfully created.' }
        format.json { render :show, status: :created, location: @borrow_policy }
      else
  ...
  def update
    respond_to do |format|
      if @borrow_policy.update(borrow_policy_params)
        format.html { redirect_to @borrow_policy, notice: 'Borrow policy was successfully updated.' }
        format.json { render :show, status: :ok, location: @borrow_policy }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to borrow_policies_url, notice: 'Borrow policy was successfully destroyed.' }
